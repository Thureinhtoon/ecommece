    ...
    <div class="aiz-sidebar left c-scrollbar">
        <div class="aiz-side-nav-logo-wrap">
            <a href="{{ route('admin.dashboard') }}" class="d-block text-left">
                ...
                @else
                    <img class="mw-100" src="{{ static_asset('assets/img/logo1.png') }}" class="brand-icon" alt="{{ get_setting('site_name') }}" style="height:100px; border-radius:20%;margin:0 auto; width:100%;">
                @endif
            </a>
        </div>
